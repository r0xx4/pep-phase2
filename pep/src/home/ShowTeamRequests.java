...
/**
 * Servlet implementation class ShowTeamRequests
 */
@WebServlet("/home/show_team_requests")
public class ShowTeamRequests extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ShowTeamRequests() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try 
		{
			if (session_ID != null)
			{
				...
				{
					RequestDispatcher rd = request.getRequestDispatcher("/home/index_team_antraege_admin.jsp");
